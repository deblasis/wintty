...
public class GhosttyActionsLayoutTests
{
    ...
    [InlineData((int)GhosttyActionTag.ShowChildExited, 56)]
    ...
    [InlineData((int)GhosttyActionTag.SearchTotal, 62)]
    [InlineData((int)GhosttyActionTag.SearchSelected, 63)]
    [InlineData((int)GhosttyActionTag.PromptReady, 66)]
    [InlineData((int)GhosttyActionTag.FirstRender, 67)]
