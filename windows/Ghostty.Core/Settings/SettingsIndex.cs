...
public static class SettingsIndex
{
    public static readonly IReadOnlyList<SettingsEntry> All = new SettingsEntry[]
    {
        ...
        new("background-opacity", "Background opacity",
            ...
            SettingType.Slider),
        new("no-color-override", "When NO_COLOR is set",
            "How Wintty reacts to an inherited NO_COLOR value: re-enable colors and notify, re-enable silently, or keep NO_COLOR (colors off).",
            "Appearance", "Color",
            new[] { "no_color", "no-color", "color", "ansi", "powerline", "environment" },
            SettingType.Combo),
